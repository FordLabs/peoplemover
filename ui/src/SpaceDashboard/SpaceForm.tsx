    ...
    return (
        <form className="createSpaceContainer" onSubmit={handleSubmit}>
            ...
            <div className="createSpaceButtonContainer">
                <button className="formButton secondaryButton" type="button" onClick={closeModal}>Cancel</button>
                <button className="formButton createSpaceSubmitButton primaryButton" type="submit" disabled={spaceNameLength <= 0}>
