...
import {AllGroupedTagFilterOptions, LocalStorageFilters} from '../../SortingAndFiltering/FilterLibraries';
...
const allGroupedTagFilterOptionsReducer = (
    ...
    if (action.type === AvailableActions.SET_ALL_FILTER_OPTIONS) {
        ...
        const sortedPersonTags: Array<FilterOption> = sortTags(copiedFilters[3].options);
        ...
        return [
            ...
            { label: 'Person Tags:', options: sortedPersonTags},
        ];
    }
    return state;
};
