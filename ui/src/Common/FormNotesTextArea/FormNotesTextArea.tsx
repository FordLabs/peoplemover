...
export default function FormNotesTextArea({
    notes = '',
    callBack,
    maxLength = 255,
    ...
    return (
        <>
            <label className="formItemLabel" htmlFor="notes">
                Notes
            </label>
            <textarea
            ...
            />
            <span
                className={`notesFieldText ${
                    notesState.length >= maxLength ? 'notesFieldTooLong' : ''
                }`}
                data-testid="notesFieldText"
            >
