...
function AssignmentCardList({ product }: Props): JSX.Element {
    ...
    const getFilteredAssignments = useCallback(() => {
        ...
        const _filteredAssignments = [...product.assignments]
            ...
            .filter((assignment: Assignment) => {
                return isPersonMatchingSelectedFilters(
                    assignment.person,
                    roleFilters,
                    personTagFilters
                );
    ...
    function sortAssignmentsByPersonRole(
        { person: person1 }: Assignment,
        { person: person2 }: Assignment
    ) {
    ...
    const classNameAndDataTestId = isUnassignedProduct(product)
        ? 'unassignedPeopleContainer'
        : 'productPeopleContainer';
